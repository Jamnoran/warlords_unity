...
public class GameLogic : MonoBehaviour
{
    ...
    public void initiateMinion(Minion newMinion)
    {
        ...
        //Debug.Log("Initiate minion[" + newMinion.minionType + "] at pos " + newMinion.desiredPositionX + "x" + newMinion.desiredPositionZ + " y: " + newMinion.desiredPositionY);
    ...
    void initiateHero(Hero newHero)
    {
        ...
        if (newHero.id == heroid)
        {
            ...
            // TODO : Add this to HeroInfo instead
    ...
    public void setAbilities(List<Ability> updatedAbilities) {
        ...
        {
            Debug.Log("Ability from server : " + ability.name);
        }
    ...
    IEnumerator crawlerLogicStart()
    {
        ...
        getCameraHandler().setParent(getMyHero().trans.gameObject);
